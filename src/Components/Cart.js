...
const Cart = () => {
    ...
    return(
        <div className="w-96 mt-5 mx-6 p-20 sm:p-0 xsm:p-0 mob:p-0 sm:flex-col xsm:flex-col mob:flex-col">
        <div className="bg-white drop-shadow-md flex-2 p-6 w-auto">
            <div className="justify-between flex items-center mb-2">
            <h1 className="font-bold text- 3xl">Cart Items </h1>
            <button className="bg-green-100 p-2 m-2"
            ...
            <div className="my-3">
                ...
                {cartItems.map((item) => (
                    <>
                    <div className="flex">
                    <p className="justify-center p-6 w-48 text-sm">{item.card.info.name}</p>
                    <div className="px-5">
